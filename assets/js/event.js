...
function renderNavigation(
  ...
  if (previous) {
    elements.previousButton.classList.remove(
      "disabled"
    );
    ...
    elements.previousButton.classList.add(
      "disabled"
    );
