...
import {
  renderCommon
} from "./common.js?v=4.5.1";

import {
  getBirthdaysForDate
} from "./birthday-data-v400.js?v=4.5.1";

import {
  drawSecretMemory,
  SECRET_MEMORY_RARITY
} from "./secret-memory-v401.js?v=4.5.1";
    ...
    elements.todayContent.innerHTML = `
      <section class="today-group">
        <div class="today-empty today-empty-special">
          <strong>今日は静かな一日です。</strong>
          <span>登録されている過去のイベント・初披露・最終披露はありません。</span>
        </div>
      </section>
    `;
