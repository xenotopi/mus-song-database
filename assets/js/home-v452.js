...
import {
  renderCommon
} from "./common.js?v=4.5.2";

import {
  getBirthdaysForDate
} from "./birthday-data-v400.js?v=4.5.2";

import {
  drawSecretMemory,
  SECRET_MEMORY_RARITY
} from "./secret-memory-v401.js?v=4.5.2";
    ...
    elements.todayContent.innerHTML = `
      <section class="today-group">
        <div class="today-empty today-empty-special">
          <strong>404: 本日のμ's史は見つかりませんでした。</strong>
          <span>データベースは正常です。今日はたまたま、記録上ちょっと静かな一日です。</span>
        </div>
      </section>
    `;
